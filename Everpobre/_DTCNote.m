...
// Make changes to DTCNote.m instead.

#import "_DTCNote.h"

const struct DTCNoteAttributes DTCNoteAttributes = {
...
@implementation DTCNoteID
@end

@implementation _DTCNote
...
- (DTCNoteID*)objectID {
	return (DTCNoteID*)[super objectID];
}
